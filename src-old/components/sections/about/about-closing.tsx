...
export function AboutClosing({ onOpenWizard }: { onOpenWizard: () => void }) {
  const { t } = useLanguage();
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            >
              {t.aboutPage.closing.ctaPrimary}
            </motion.button>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            ...
            >
              {t.aboutPage.closing.ctaSecondary}
            </motion.button>
          </div>
        </motion.div>
      </div>
